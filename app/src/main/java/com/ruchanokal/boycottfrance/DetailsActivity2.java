...
public class DetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Details2Banner
        //ca-app-pub-5016889744069609/1740272134
        ...
        String brandName = intent.getStringExtra("productName");
        String brandDetail = intent.getStringExtra("productDetail");
        groupIndex = intent.getIntExtra("groupIndex",0);
        childIndex = intent.getIntExtra("childIndex",0);


        brandNameText.setText(brandName);
        detailText.setText(brandDetail);
    ...
    private void getGroupandChildIndex() {
        if (groupIndex == 0 && childIndex == 0) {
            ...
            a=94;
        } else if(groupIndex==25 && childIndex==0) {
            a=95;
    ...
    private void getDatafromFirabase() {


        firebaseDatabase = FirebaseDatabase.getInstance().getReference().child("Images").child(String.valueOf(a)).child("downloadurl");
        ...
        firebaseDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Picasso.get().load(imageUri).into(logoImage2);
            }
